...
public static void main(String[] args) {
     ...
     num1 = generator.nextInt(9) + 1; //add 1 so there is no 0 to begin  
     num2 = generator.nextInt(1); //randomize to 8 becuase 0 counts as a number in the generator
     ...
     System.out.println ( "+91"+"(" + num1 + "" + num2 + "" + num3 + ")" + "-" + set2 + "-" + set3 );
